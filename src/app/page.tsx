...
const links = [
  { name: 'GitHub', href: 'https://github.com/jujospring' },
  { name: 'LinkedIn', href: 'https://linkedin.com/in/julianspring'},
  { name: 'Resume', href: '#' },
  { name: 'Surprise', href: '#' },
]
  ...
  return (
    <main className="flex min-h-screen items-center flex-col justify-between p-24 bg-[url('../../public/crumpled-paper.jpg')] bg-fixed bg-cover">
      ...
      <div data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-duration="800">
        <div className="mb-20 mx-auto overflow-hidden rounded-md p-4 py-24 sm:py-32 backdrop-blur-sm transition hover:backdrop-blur duration-500 bg-white/30"> 
      ...
      <footer className="mx-auto overflow-hidden rounded-md backdrop-blur-sm transition hover:backdrop-blur duration-500 bg-white/30">
